    ...
    <div>
        <div class="flex flex-col flex-1 items-center">
            ...
            <div class="flex flex-col items-center text-white py-12">
                <h1 class="text-4xl mb-2">{{ route.params.city.replace(/([A-Z])/g, ' $1') }}</h1>
...
<script setup>
    ...
    const getWeatherData = async () => {
        try {
            const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&appid=bb97c3056aa8ce1c35113df190782271&units=metric`);
